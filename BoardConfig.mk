...
# Kernel
BOARD_KERNEL_CMDLINE := console=ttyMSM0,115200,n8 androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 msm_rtb.filter=0x237 service_locator.enable=1 androidboot.usbcontroller=a600000.dwc3 swiotlb=2048 cgroup.memory=nokmem,nosocket loop.max_part=7 reboot=panic_warn
...
BOARD_PREBUILT_DTBOIMAGE := $(DEVICE_PATH)/prebuilt/dtbo.img-12.5.7
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/kernel-12.5.7
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/dtb-12.5.7
